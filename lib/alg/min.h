...
typedef real (*AlgMinF )(int n, const real *xx, const real *yy, const real *zz, void *param);
typedef void (*AlgMinDF)(int n, const real *xx, const real *yy, const real *zz, void *param, /**/
