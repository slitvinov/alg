...
static real Energy0(int __UNUSED n, const real *xx, const real *yy, const real *zz,
       void __UNUSED *param) {
    return Energy(xx, yy, zz);
}

static void Force0(__UNUSED int n,
...
real min_energy() { return alg_min_energy(min);  }
int min_end()     { return alg_min_end(min); }

int min_force(real *x, real *y, real *z) {
    int i;
    real *fx, *fy, *fz;
